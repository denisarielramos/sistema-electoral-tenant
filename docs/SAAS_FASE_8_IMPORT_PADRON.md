...
El archivo debe tener este encabezado exacto:

```csv
ci,nombre,apellido,localidad,local_votacion,seccional,mesa,orden,direccion
```
...
La importacion agrega automaticamente `campania_id` a cada registro.
